...
#ifdef __AMIGA__
#define VWB_DrawPicScaledCoord VWB_DrawPic
#else
...
/*#define LatchDrawChar(x,y,p) VL_LatchToScreen(latchpics[0]+(p)*16,2*4,8,x,y)
#define LatchDrawTile(x,y,p) VL_LatchToScreen(latchpics[1]+(p)*64,4*4,16,x,y)*/

void    LatchDrawPic (unsigned x, unsigned y, unsigned picnum);
#ifdef __AMIGA__
#define LatchDrawPicScaledCoord LatchDrawPic
#else
